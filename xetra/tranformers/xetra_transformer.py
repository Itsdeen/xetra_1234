...
class XetraSourceConfig(NamedTuple):
    ...
    sc_col_date : column name for date insource
    src_col_isin: column name for ising in source
    src_col_time: column name for tiem in source
    ...
    src_col_traded_vol: column name for traded volume n source
    """
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_ch_prev_clos: column name for maximm price in target
